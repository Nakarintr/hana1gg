...
<head>
    <meta charset="UTF-8">
    <title>insert_type_of_medicine</title>
...
<body>
 <!-- Navbar ด้านบน -->
        ...
        <div class="text-center fs-4 fw-bold">ข้อมูลประเภทสัตว์</div>
        
        
<form action="show_of_pet_hana.php" method="post" enctype="multipart/form-data">
  
         
รหัสประเภทสัตว์ : 
         <div class="input-group mt-1">
         <div class="input-group-text bg-Gainsboro"><i class="fa fa-book"></i></div>
       <input class="form-control bg-light" type="text" name="Type_of_pet_ID" placeholder="กรอก รหัสประเภทยารักษา" required></div>
ชื่อประเภทสัตว์ :<font color='red'>*ชื่อ</font>       
       <div class="input-group mt-1">
          <div class="input-group-text bg-Gainsboro"><i class="fa fa-file-text"></i></div>
         <input class="form-control bg-light" type="text" name="Type_of_pet_Name" placeholder="ชื่อประเภทยารักษา" required></div>
         ตรวจดูข้อมูล : <a href="insert_of_pet_hana.php"> ดูข้อมูลประเภทประเภทสัตว์ </a>

        <center><input type="submit" name= "login"  value= "ประเภทสัตว์" class="btn btn-dark text-white w-100 mt-2" ></center><br>
