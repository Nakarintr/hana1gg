...
<body>
 <!-- Navbar ด้านบน -->
        ...
        <div class="text-center fs-4 fw-bold">ข้อมูลประเภทยารักษา</div>
        
        
<form action="show_type_of_medicine.php" method="post" enctype="multipart/form-data">
...
ชื่อประเภทยารักษา :<font color='red'>*ชื่อ</font>       
       <div class="input-group mt-1">
         ...
         <input class="form-control bg-light" type="text" name="Type_of_medicine_Name" placeholder="ชื่อประเภทยารักษา" required></div>
         ตรวจดูข้อมูล : <a href="insert_type_of_medicine.php"> ดูข้อมูลประเภทยารักษา </a>

        <center><input type="submit" name= "login"  value= "ประเภทยารักษา" class="btn btn-dark text-white w-100 mt-2" ></center><br>
