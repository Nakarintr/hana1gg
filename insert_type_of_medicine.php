...
<head>
    <meta charset="UTF-8">
    <title>แสดงข้อมูลประเภทยารักษา</title>
...
<br>
<center><h1>ข้อมูลประเภทยารักษา</h1></center>
<center><a href="type_of_medicine_hana.php">เพิ่มข้อมูลประเภทยารักษา</a></center><br>
...
<div class="table-responsive">
    ...
    <thead class="bg-danger text-white">
            ...
            <th width="5%" style="vertical-align:middle;">รหัสประเภทยารักษา</th>
            <th width="10%" style="vertical-align:middle;">ชื่อประเภทยารักษา</th>
            ...
            <?php
                ...
                $sql = "SELECT * FROM type_of_medicine";
        ...
        <tbody>
            ...
            <td> <center><?php echo $list; ?></center> </td>
                ...
                <td> <center><?php echo $result['Type_of_medicine_Name']; ?></center> </td>

                <td> <center><a href="edit_type_of_medicine.php?Type_of_medicineID=<?php echo $result['Type_of_medicine_ID']; ?>">แก้ไข<i class='fa fa-edit' style='font-size:24px;color:black'></i></a></center></td>
                <td> <center><a href="delete_type_of_medicine.php?Type_of_medicineID=<?php echo $result['Type_of_medicine_ID']; ?>">ลบ<i class="fa-solid fa-trash" style="color: #000000;"></i></a> </center></td>    
