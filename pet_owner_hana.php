...
<body>
 <!-- Navbar ด้านบน -->
        ...
        <div class="text-center fs-4 fw-bold">ข้อมูลเจ้าของสัตว์</div>
        
        
<form action="show_pet_owner.php" method="post" enctype="multipart/form-data">
...
ที่อยู่เจ้าของสัตว์:       
       <div class="input-group mt-1">
         ...
         ตรวจดูข้อมูล : <a href="insert_pet_owner.php"> ดูข้อมูลเจ้าของสัตว์ </a>

        <center><input type="submit" name= "login"  value= "เจ้าของสัตว์" class="btn btn-dark text-white w-100 mt-2" ></center><br>
