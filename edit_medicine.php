...
<head>
    <meta charset="UTF-8">
    <title>แก้ไขข้อมูลยารักษา</title>
...
<body>
    <?php
        ...
        $sql = "SELECT * FROM medicine WHERE medicine_ID = '".$_GET['medicineID']."'";
...
จำนวนยา :       
       <div class="input-group mt-1">
        ...
        <div class="text-center fs-2 fw-bold">ระบบแก้ไข/ยารักษา</div>
        <form action="update_medicine.php" name="form_1" method="POST" enctype="multipart/form-data">  
        
               <input type="hidden" name="medicine_ID" value="<?php echo $_GET['medicineID']; ?>">
        
       
        <center><input type="submit" name= "update"  value= "แก้ไขข้อมูลยารักษา" class="btn btn-dark text-white w-100 mt-2" ></center><br>
        หน้าแรก :&nbsp;<a href="insert_medicine_ID.php">Back</a>
