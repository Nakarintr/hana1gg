...
<head>
    <meta charset="UTF-8">
    <title>แสดงข้อมูลประเภทสัตว์</title>
...
<br>
<center><h1>ข้อมูลประเภทสัตว์</h1></center>
<center><a href="type_of_pet_hana.php">เพิ่มข้อมูลประเภทสัตว์</a></center><br>
...
<div class="table-responsive">
    ...
    <thead class="bg-danger text-white">
            ...
            <th width="5%" style="vertical-align:middle;">รหัสประเภทสัตว์</th>
            <th width="10%" style="vertical-align:middle;">ชื่อประเภทสัตว์</th>
            ...
            <?php
                include("compu_type_of_pet.php");
                $sql = "SELECT * FROM type_of_pet";
        ...
        <tbody>
            ...
            <td> <center><?php echo $list; ?></center> </td>
                ...
                <td> <center><?php echo $result['type_of_pet_Name']; ?></center> </td>

                <td> <center><a href="edit_type_of_pet.php?type_of_petID=<?php echo $result['type_of_pet_ID']; ?>">แก้ไข<i class='fa fa-edit' style='font-size:24px;color:black'></i></a></center></td>
                <td> <center><a href="delete_type_of_pet.php?type_of_petID=<?php echo $result['type_of_pet_ID']; ?>">ลบ<i class="fa-solid fa-trash" style="color: #000000;"></i></a> </center></td>    
